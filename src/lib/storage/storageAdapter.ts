...
export const getAuthService = async () => {
  if (USE_SQLITE) {
    return import('@/lib/auth/authServiceSQLite');
  } else {
    return import('@/lib/auth/authService');
  }
};
...
export const getTrackService = async () => {
  if (USE_SQLITE) {
    return import('@/lib/playlist/trackServiceSQLite');
  } else {
    return import('@/lib/playlist/trackService');
  }
};
...
export const getFileService = async () => {
  if (USE_SQLITE) {
    return import('@/lib/storage/fileServiceSQLite');
  } else {
    return import('@/lib/storage/fileService');
  }
};
...
export const getChatService = async () => {
  if (USE_SQLITE) {
    return import('@/lib/chat/chatServiceSQLite');
  } else {
    return import('@/lib/chat/chatService');
  }
};
